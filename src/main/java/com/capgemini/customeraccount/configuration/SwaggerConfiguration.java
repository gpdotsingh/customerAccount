...
public class SwaggerConfiguration {
    ...
    public Docket bookHotelApi() {
        return new Docket( DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.capgemini.customeraccount.controller"))
                .build()
                .apiInfo(getApiInfo());
    }
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                ...
                .version("1.0")
                .description("Application responsible for entry point and user info details..")
                .build();
    }
}
