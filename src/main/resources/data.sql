...
create table customer (id bigint not null, customer_id varchar(10),first_name varchar(100),middle_name varchar(100),last_name varchar(100), primary key (id));
...
insert into customer(id,customer_id,first_name,last_name) values(2 ,'customer2','Neymar','White');
insert into customer(id,customer_id,first_name,middle_name,last_name) values(3 ,'customer3','Joshua','Kumar','Kimmich');
...
insert into customer(id,customer_id,first_name,last_name) values(9 ,'customer9','Kylian','Mbappe');
